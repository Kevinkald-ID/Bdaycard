...
const config = {
    name: "Hey Kevin", // actual name of the recipient (Mandatory)

    nickname: "I lOVE You Kevin don't ever change, stay the Kevin That I know Love yah", // nickname(optional)
...
CTAtext.innerHTML = "Bitch Click The Light Bulb.";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        light.play();
        transition(darkroom);
        CTAtext.innerHTML = "Are u dumb Or what Click the door";
        setTimeout(function() {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Happy Birth Day Hoe:)";
